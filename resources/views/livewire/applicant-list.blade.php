<x-module-section>
  <h1 class="mb-4">Applicants</h1>
        ...
        @csrf 
                <x-input id="name" class="block mt-1 w-full" placeholder="Search By Name / Email / Application No" type="text" name="name"  wire:model.live="name" :value="old('name')" required autofocus autocomplete="name" />
        ...
        @foreach(($this->getUsers()) as $user)
         <tr class="border-b-2">
            ...
            <td class="flex gap-3 align-middle items-center"> 
                ...
                <form action="{{route('applicant', $user->id)}}" method="get"> <x-button class=" bg-yellow-400">Show</x-button></form>  
